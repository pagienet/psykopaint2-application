package net.psykosoft.psykopaint2.assets.away3d.textures
{
	...
	public class Away3dAtlasTextureDescriptorVO
	{
		...
		public function Away3dAtlasTextureDescriptorVO( textureName:String, atlasXml:XML, textureWidth:Number, textureHeight:Number ) {
			width = textureWidth;
