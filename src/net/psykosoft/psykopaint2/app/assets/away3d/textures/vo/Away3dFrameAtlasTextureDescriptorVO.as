package net.psykosoft.psykopaint2.app.assets.away3d.textures.vo
{
	import flash.geom.Rectangle;

	/*
	* Stores and extracts information for a particular frame texture in the frames texture atlas.
	* */
	public class Away3dFrameAtlasTextureDescriptorVO
	{
		...
		public function Away3dFrameAtlasTextureDescriptorVO( textureName:String, atlasXml:XML, textureWidth:Number, textureHeight:Number ) {
			width = textureWidth;
