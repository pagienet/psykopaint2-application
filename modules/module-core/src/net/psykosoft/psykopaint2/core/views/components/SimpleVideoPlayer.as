package net.psykosoft.psykopaint2.core.views.components
{
	...
	public class SimpleVideoPlayer
	{
		...
		private var _removeOnComplete:Boolean;
		...
		public function get removeOnComplete():Boolean
		{
			return _removeOnComplete;
		}
		
		public function set removeOnComplete(val:Boolean):void
		{
			_removeOnComplete = val;
		}
