...
public class ButtonGroup extends Sprite {
	...
	private var _buttonPositionOffsetX:Number = 0; //TODO
	...
	public function setButtonWithLabelSelected(label:String):void {
		var len:uint = _buttons.length;
		for (var i:uint; i < len; ++i) {
			var btn:SbButton = _buttons[ i ];
			if (btn.labelText == label) {
				_selected = btn;
	...
	public function selectedBtnLabel():String {
