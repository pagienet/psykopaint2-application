package away3d.filters
{
	...
	import away3d.filters.tasks.SmartFilter3DHDepthOfFieldTask;
	import away3d.filters.tasks.SmartFilter3DVDepthOfFieldTask;
	
	import flash.display3D.textures.Texture;
	
	import flash.geom.Vector3D;
	
	public class SmartDepthOfFieldFilter3D extends Filter3DBase
	{
		private var _focusTarget:ObjectContainer3D;
		private var _hDofTask:SmartFilter3DHDepthOfFieldTask;
		private var _vDofTask:SmartFilter3DVDepthOfFieldTask;
		 ...
		 */
		public function SmartDepthOfFieldFilter3D(maxBlurX:uint = 3, maxBlurY:uint = 3, stepSize:int = -1)
		{
			super();
		...
		public function get smartRange():Number
		{
			return _vDofTask.smartRange;
		}
