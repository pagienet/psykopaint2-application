package net.psykosoft.psykopaint2.paint.views.crop
{
	...
	import net.psykosoft.psykopaint2.core.views.components.CrTouchSheet;

	public class PtCropView extends BsViewBase
	{
		// TODO: commented by li, we don't use starling anymore
		private var _positioningSheet:CrTouchSheet;
		...
		public function set sourceMap( map:BitmapData ):void {
			...
			_positioningSheet = new CrTouchSheet( _sourceMap );
