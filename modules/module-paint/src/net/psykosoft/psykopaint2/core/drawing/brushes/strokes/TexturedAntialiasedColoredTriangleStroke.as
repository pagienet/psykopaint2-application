package net.psykosoft.psykopaint2.core.drawing.brushes.strokes
{
	...
	public class TexturedAntialiasedColoredTriangleStroke extends TriangleStroke
	{
		...
		override public function drawHeightAndSpecular(context3d : Context3D, canvas : CanvasModel, shininess : Number, glossiness : Number, bumpiness : Number) : void
		{
			var vertexBuffer : VertexBuffer3D = getVertexBuffer(context3d);
		...
		override protected function getHeightSpecularVertexCode() : String
		{
			return 	"mov op, va0\n" +
					"mov v0, va1\n" +
					"mov v1, va2\n";
		...
		override protected function getHeightSpecularFragmentCode() : String
		{
