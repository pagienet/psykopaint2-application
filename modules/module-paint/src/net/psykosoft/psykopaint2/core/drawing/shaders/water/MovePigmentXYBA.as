package net.psykosoft.psykopaint2.core.drawing.shaders.water
{
	...
	public class MovePigmentXYBA extends SimStepRenderer
	{
		private var _canvas : CanvasModel;
		private var _vertexProps : Vector.<Number>;
		private var _fragmentProps : Vector.<Number>;

		[Embed(source="/../shaders/agal/MovePigmentXYBA_fixed.agal", mimeType="application/octet-stream")]
		private var Shader : Class;

		public function MovePigmentXYBA(context : Context3D, canvas : CanvasModel)
		{
			super(context);
			_canvas = canvas;
