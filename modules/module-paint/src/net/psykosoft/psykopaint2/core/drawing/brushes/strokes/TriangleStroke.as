package net.psykosoft.psykopaint2.core.drawing.brushes.strokes
{
	...
	public class TriangleStroke extends AbstractBrushMesh
	{
		public function TriangleStroke()
		{
			super();
		}
		...
		override public function drawColor(context3d : Context3D, canvas : CanvasModel, source : TextureBase = null) : void
		{
			...
			context3d.setVertexBufferAt(1, vertexBuffer, 2, Context3DVertexBufferFormat.FLOAT_2); //uv is useless for nowbut it's easier to leave it in
