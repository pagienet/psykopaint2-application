package net.psykosoft.psykopaint2.core.drawing.paths.decorators
{
	...
	final public class BumpDecorator extends AbstractPointDecorator
	{
		...
		public static const PARAMETER_NR_BUMPYNESS : String = "Bumpyness";
		...
		public function BumpDecorator()
		{
			...
			bumpInfluence = new PsykoParameter( PsykoParameter.NumberParameter,      PARAMETER_N_BUMP_INFLUENCE, 0.6, 0, 1 );
