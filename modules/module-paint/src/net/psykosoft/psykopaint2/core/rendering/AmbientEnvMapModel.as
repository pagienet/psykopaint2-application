package net.psykosoft.psykopaint2.core.rendering
{
	...
	public class AmbientEnvMapModel extends BDRFModel
	{
		protected var _fragmentShaderData : Vector.<Number>;

		[Embed(source="/../shaders/agal/CanvasAmbientEnvMap.agal", mimeType="application/octet-stream")]
		private var Shader : Class;

		private var _envMap : Texture;

		public function AmbientEnvMapModel()
		{
			super();
