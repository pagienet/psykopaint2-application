package net.psykosoft.psykopaint2.home.views.home.objects
{
	...
	/*
	* Represents the frame of a painting without the actual painting/drawing itself.
	* */
	public class Frame extends ObjectContainer3D
	{
		...
		public function Frame( frameMaterial:TextureMaterial, frameDescriptor:FrameTextureAtlasDescriptorVO, contentWidth:Number, contentHeight:Number ) {
			super();
			...
			_textureDescriptor = frameDescriptor;
		...
		public function get width():Number {
			return _contentWidth + 2 * _frameMargin;
		}

		public function get height():Number {
			return _contentHeight + 2 * _frameMargin;
		}
		...
		private function calculateAnchorPoints():void {
			...
			var dw:Number = _contentWidth / 2;
			var dh:Number = _contentHeight / 2;
